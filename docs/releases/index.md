...
### HPE Storage Array Exporter for Prometheus 1.0.5

Release highlights:

- Addressed critical CVEs
- Support more than 1000 volumes with Nimble derived platforms

<table>
 <tr>
   <th>Binaries and Release Notes</th>
   <td>
    <a href="https://github.com/hpe-storage/array-exporter/releases/tag/v1.0.5">1.0.5</a> on GitHub
   </td>
 </tr>
 <tr>
   <th>Helm Chart</th>
   <td>
    <a href="https://artifacthub.io/packages/helm/hpe-storage/hpe-array-exporter/1.0.5">1.0.5</a> on Artifact Hub
   </td>
 </tr>
 <tr>
